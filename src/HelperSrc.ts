...
export const PATH_CERTIFICATE_KEY = Ce.checkVariable("MS_O_PATH_CERTIFICATE_KEY") || (process.env.MS_O_PATH_CERTIFICATE_KEY as string);
export const PATH_CERTIFICATE_CRT = Ce.checkVariable("MS_O_PATH_CERTIFICATE_CRT") || (process.env.MS_O_PATH_CERTIFICATE_CRT as string);
export const PATH_PUBLIC = Ce.checkVariable("MS_O_PATH_PUBLIC") || (process.env.MS_O_PATH_PUBLIC as string);
export const PATH_LOG = Ce.checkVariable("MS_O_PATH_LOG") || (process.env.MS_O_PATH_LOG as string);
export const PATH_FILE_INPUT = Ce.checkVariable("MS_O_PATH_FILE_INPUT") || (process.env.MS_O_PATH_FILE_INPUT as string);
export const PATH_FILE_OUTPUT = Ce.checkVariable("MS_O_PATH_FILE_OUTPUT") || (process.env.MS_O_PATH_FILE_OUTPUT as string);
export const PATH_FILE_SCRIPT = Ce.checkVariable("MS_O_PATH_FILE_SCRIPT") || (process.env.MS_O_PATH_FILE_SCRIPT as string);
